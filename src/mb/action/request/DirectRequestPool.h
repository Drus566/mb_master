#ifndef MB_DIRECT_REQUEST_POOL_H
#define MB_DIRECT_REQUEST_POOL_H
...
class DirectRequestPool {
public:
	DirectRequestPool(size_t pool_size) { m_pool.resize(pool_size); }
	DirectRequest *acquire() {
...
#endif // MB_DIRECT_REQUEST_POOL_H
